...
import org.camunda.bpm.run.utils.CamundaBpmRunProcessEnginePluginConfigurator;
...
public class CamundaBpmRunConfiguration {
  ...
  public ProcessEngineConfigurationImpl processEngineConfigurationImpl(List<ProcessEnginePlugin> processEnginePlugins) {
    ...
    CamundaBpmRunProcessEnginePluginConfigurator.registerYamlPlugins(processEnginePlugins, yamlPluginsInfo);
